# CSS Fundamentals Showcase

23 Pages with a lot of HTML, CSS and love... ❤️‍🩹🥀

> “I don't know what to put here, but I think a quote would look good.” - Me (maybe, someone probably used this quote actually).
...
* Layouts with **Float** and **Flexbox**.
* **Interactivity** with **Pseudo-classes**.
* Custom **Navigation Bars** and **Dropdown menus**.
* Integration of **Third-Party Icon Libraries**.
* Keyframe **Animations** and Transitions.
* **Shadows**, **Gradients**, and **Transparency**.
* Advanced **Box Model** (Containers, Boxes, and Borders).
* Mastery of **Dimensions**, **Displays**, and **Positions**.
